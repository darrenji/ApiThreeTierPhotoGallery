...
using ApiThreeTierPhotoGallery.Infrastructure;
using Microsoft.EntityFrameworkCore;
using ApiThreeTierPhotoGallery.Infrastructure.Repositories.Abstract;
using ApiThreeTierPhotoGallery.Infrastructure.Repositories;
using ApiThreeTierPhotoGallery.Infrastructure.Services.Abstract;
using ApiThreeTierPhotoGallery.Infrastructure.Services;
using Newtonsoft.Json.Serialization;
using ApiThreeTierPhotoGallery.Infrastructure.Mappings;
using System.Security.Claims;

namespace ApiThreeTierPhotoGallery
{
